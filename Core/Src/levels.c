...
static const uint8_t level5[] = {
    KEY_GREEN, KEY_YELLOW, KEY_BLUE, KEY_RED, KEY_YELLOW, KEY_RED, KEY_BLUE,
    KEY_GREEN, KEY_GREEN, KEY_GREEN, KEY_RED, KEY_BLUE, KEY_BLUE, KEY_GREEN,
    KEY_YELLOW, KEY_RED, KEY_YELLOW, KEY_GREEN, KEY_RED, KEY_BLUE, KEY_GREEN,
    KEY_YELLOW, KEY_RED, KEY_BLUE, KEY_BLUE, KEY_BLUE, KEY_RED, KEY_BLUE,
